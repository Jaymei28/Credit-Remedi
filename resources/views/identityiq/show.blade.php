    ...
    <div class="container">
        ...
        <div class="summary-cards">
            <div class="summary-card info">
                ...
                <div class="value">{{ $totalAccountsCount }}</div>
            </div>
            ...
            <div class="summary-card success">
                ...
                <div class="value">{{ $openAccountsCount }}</div>
            </div>
            ...
            <div class="summary-card danger">
                ...
                <div class="value">{{ $negativeAccountsCount }}</div>
            </div>
            ...
            <div class="summary-card warning">
                ...
                <div class="value">{{ $hardInquiriesCount }}</div>
            </div>
        </div>

        {{-- Smart Extraction Info Box --}}
        <div class="alert" style="background: rgba(59, 130, 246, 0.1); border-left: 4px solid #3b82f6; border-radius: 8px; padding: 1rem 1.5rem; margin-bottom: 2rem;">
            <div style="display: flex; align-items: start; gap: 1rem;">
                <i class="bi bi-info-circle" style="color: #3b82f6; font-size: 1.5rem; margin-top: 0.25rem;"></i>
                <div>
                    <h6 style="color: #3b82f6; font-weight: 700; margin: 0 0 0.5rem 0;">ℹ️ Smart Extraction</h6>
                    <p style="color: #6b7280; margin: 0; font-size: 0.9rem; line-height: 1.6;">
                        The summary counts above are extracted directly from your credit report's official Summary section and are 100% accurate. 
                        The detailed account listings below show <strong>all negative items</strong> plus a sample of your most important open accounts. 
                        This prioritization ensures you can immediately focus on accounts that need attention for credit repair.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="data-table-section positive">
            <div class="table-header positive">
                <h5>
                    <i class="bi bi-check-circle"></i>
                    Open Accounts (Showing {{ $openAccounts->count() }} of {{ $openAccountsCount }})
                </h5>
                <small>Displaying key open accounts in good standing • All {{ $openAccountsCount }} accounts counted in summary above</small>
            </div>
            <div class="table-responsive">
                <table class="data-table">
                    <thead>
        ...
        <div class="data-table-section warning">
            <div class="table-header warning">
                <h5>
                    <i class="bi bi-search"></i>
                    Hard Inquiries ({{ $hardInquiriesCount }} Unique)
                </h5>
                <small>Deduplicated across all three bureaus • {{ $inquiries->count() }} total inquiry records</small>
            </div>
            <div class="table-responsive">
                <table class="data-table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('credit-repair-bot') }}?dispute=true&creditor={{ urlencode($inquiry->creditor_name) }}&account_type=Hard Inquiry&status=Inquiry&bureau={{ urlencode($inquiry->bureau ?? 'All Bureaus') }}&reason=Unauthorized inquiry" class="action-btn" data-test="inquiry-dispute-v2">
                                    <i class="bi bi-file-earmark-plus me-1"></i>Dispute
                                </a>
                            </td>
                        </tr>
        ...
        <div class="steps-section">
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h6>Dispute Negative Items</h6>
                    <p>Review the details of the negative accounts identified and initiate a dispute process for any inaccuracies or outdated information to potentially improve your credit score.</p>
                    <a href="{{ route('disputes.index') }}" class="step-btn primary">
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h6>Get AI Assistance</h6>
                    <p>Chat with Credit Remedi AI for personalized credit repair strategies tailored to your specific situation and credit profile.</p>
                    <a href="{{ route('credit-repair-bot') }}" class="step-btn secondary">
                        <i class="bi bi-robot"></i>
                        Chat with AI
                    </a>
                </div>
